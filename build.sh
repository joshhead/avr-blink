#!/bin/sh
avr-gcc -c -I. -Os -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -Wall -Wstrict-prototypes -DF_CPU=8000000 -Wa,-adhlns=blink.lst -mmcu=attiny85 -std=gnu99 blink.c -o blink.o
